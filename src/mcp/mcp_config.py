...
MCP_SERVERS: Dict[str, Dict[str, Any]] = {
    ...
    "jobspy": {
        "name": "jobspy",
        "description": "Search for real job listings across multiple platforms (LinkedIn, Indeed, Glassdoor, ZipRecruiter, Google, Bayt, Naukri) using JobSpy",
        "command": "node",
        "args": ["dependencies/jobspy-mcp-server/src/index.js"],
        "env": {},
        "tools": ["search_jobs"],
    },
    "firecrawl": {
