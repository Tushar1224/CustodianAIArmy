...
Source: https://www.tutorialspoint.com/sql/index.htm
...
SQL Tutorial
SQL tutorial
helps you learn SQL (Structured Query Language) in simple and easy steps so that you can start your database programming quickly. It covers most of the important concepts related to SQL for a basic to advanced understanding of SQL and to get a feel of how SQL works.
...
is a database computer language designed for the retrieval and management of data in a relational databases like MySQL, MS Access, SQL Server, Oracle, Sybase, Informix, Postgres etc.
stands for
Structured Query Language
. SQL was developed in the 1970s by IBM Computer Scientists.
is not a database management system, but it is a query language which is used to store and retrieve the data from a database or in simple words SQL is a language that communicates with databases.
SQL Examples
...
Edit
Execute
the SQL code directly from your browser. Try to click the icon
to run the following SQL code to be executed on
CUSTOMERS
table and print the records matching with the given condition.
SELECT * FROM CUSTOMERS WHERE country = 'USA';
So now, you do not need to do a sophisticated setup to execute all the examples given in this tutorial because we are providing you
Online SQL Editor
, which allows you to edit your code and compile it online. You can try our
Online SQL Editor
SQL Basic Commands
...
This
SQL tutorial
will help both students as well as working professionals who want to develop applications based on some databases like banking systems, support systems, information systems, web websites, mobile apps or personal blogs etc. We recommend reading this tutorial, in the sequence listed in the left side menu.
...
- The SQL programming language was developed by which of the following:
- Google in 1990s
- Microsoft in 1980s
- IBM in 1970s
- None of the Above
